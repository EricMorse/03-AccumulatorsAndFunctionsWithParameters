...
def run_test_even_better_draw_circles():
    ...
    print('--------------------------------------------------')
    even_better_draw_circles(3, 20, rg.Point(100, 300))
    even_better_draw_circles(5, 10, rg.Point(250, 50))
    even_better_draw_circles(10, 5, rg.Point(200, 200))


def even_better_draw_circles(n, num, center):
    """
    -- Constructs a window whose width and height are both 400.
    -- Constructs and draws 21 rg.Circle objects such that:
         -- Each is centered at Point center
         -- They have radii:  0  n  2n  3n  4n ... 20n, respectively.
         -- Pauses 0.05 seconds after rendering each.
    -- Waits for the user to press the mouse, then closes the window.
    """
